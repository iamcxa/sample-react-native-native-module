...
public class RNMyToastModuleModule extends ReactContextBaseJavaModule {
    ...
    // 預設建構子
    public RNMyToastModuleModule(ReactApplicationContext reactContext) {
        super(reactContext);
